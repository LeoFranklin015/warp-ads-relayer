...
const getUserLabels_1 = require("./utils/mbd/getUserLabels");
...
app.get("*", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const targetLabels = yield (0, getUserLabels_1.getUserLabels)(frame_data.untrustedData.fid.toString());
...
`;
    ...
    try {
        const response = yield fetch(url, options1);
        const data = yield response.json();
        const ads = data.data.ads;
        // Filter ads that match any of the target labels
        const filteredAds = ads.filter((ad) => ad.labels.some((label) => targetLabels.includes(label)));
    ...
    try {
        const _a = req.headers, { "set-cookie": _ } = _a, filteredHeaders = __rest(_a, ["set-cookie"]);
        let response = yield (0, axios_1.default)({
            method: req.method,
            url: targetUrl,
            data: req.body,
            headers: Object.assign(Object.assign({}, filteredHeaders), { host: new URL(targetUrl).host }),
            responseType: "stream",
        });
        try {
            ...
            response.data.on("end", () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const metaElement = dom.window.document.querySelector('meta[name="fc:frame:image"]');
                ...
                const satoriImg = yield (0, satori_1.default)(mainUrl, logo, description, title);
                if (metaElement) {
